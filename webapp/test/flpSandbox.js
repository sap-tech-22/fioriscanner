		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Students",
									"targetURL": "#samplefiorisap-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"samplefiorisap-display": {
								"semanticObject": "samplefiorisap",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=samplefiorisap",
									"url": sap.ui.require.toUrl("samplefiorisap")
								}
							}
						}
					}
